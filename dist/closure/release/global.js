...
const debugMod = goog.require('incrementaldom.src.debug');


let keyAttributeName = "key";

/**
 * Return the global key attribute name.
 * @return The global key attribute name.
 */
...
/**
 * Set the global key attribute name.
 * @param {!string} name Key attribute name.
 */
