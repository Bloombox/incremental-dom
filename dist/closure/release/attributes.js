...
const symbolsModule = goog.require('incrementaldom.src.symbols');
...
function applyStyle(el, name, style) {
    ...
    assertionsModule.assert("style" in el);
 ...
 */
const attributes = utilModule.createMap();
// Special generic mutator that's called for any attribute that does not
// have a specific mutator.
attributes[symbolsModule.symbols.default] = applyAttributeTyped;
...
function updateAttribute(el, name, value) {
    const mutator = attributes[name] || attributes[symbolsModule.symbols.default];
